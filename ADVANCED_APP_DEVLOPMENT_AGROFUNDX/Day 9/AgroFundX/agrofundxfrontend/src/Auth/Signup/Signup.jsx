...
const Signup = () => {
  ...
  const validateFirstName = () => {
    return !!firstName && !/\d/.test(firstName);
  };

  const validateLastName = () => {
    return !!lastName && !/\d/.test(lastName);
  };
  ...
  return (
    <>
      <main>
        <section className="max-w-full font-ambitregular lg:h-[100vh]  xl:min-h-[100vh] ">
          {error && (
            <>
          ...
          <div className="xl:w-[100%] z-[2] lg:bg-white  lg:flex-col xl:flex xl:justify-between min-h-screen xl:bg-[#fbf8f6]">
            <div className="font-ambitregular relative  flex flex-col xl:gap-10 items-left xl:h-[25em] lg:h-[15em] xl:p-16 lg:p-8 lg:gap-10 ">
              <figure
                onClick={() => navigate("/home")}
                className="w-14 xl:mb-12 lg:mt-8 ">
                <img src={logo} alt="" />
              </figure>
              <div className="lg:mt-5 xl:mt-3 flex flex-col xl:gap-8  lg:gap-5">
                <div>
                  <h1 className="text-md text-darkgray">
                    Welcome to AgroFundX
                  </h1>
                </div>
                <div>
            ...
            <div className=" rounded-tl-[5em] bg-white lg:w-[100%]   xl:w-[55em] xl:shadow-xl">
              ...
              <form onSubmit={handleSubmit}>
                <div
                  className="xl:px-32 xl:mt-12 xl:pb-16 lg:px-8 lg:py-8 xl:max-h-[22em] xl:overflow-y-scroll bg-white  "
                  action="">
                  <div className="flex flex-col   gap-6 w-[37rem] lg:w-[100%]">
                    ...
                    <div className="flex text-darkgray2 lg:items-center xl:items-start gap-7">
                      ...
                      <p>
                        Receive tips to help you maximize your farming financing
                        platform, along with updates about agricultural trends
                        and important developments in farming finance.
                        Unsubscribe anytime.
                      </p>
                    </div>
                  </div>
                </div>
                <footer className="lg:relative xl:px-32 xl:py-6 lg:px-8 lg:py-12 xl:border-t-[1px] xl:border-lightgray1 fixed ">
                  <div className="flex lg:flex-col  lg:gap-10 lg:items-center xl:items-center ">
                    <div className="text-[#838383]">
                      <p className="tracking-wide ">
                        By continuing,you agree to the AgroFundX
