...
const SignIn = () => {
  ...
  return (
    <>
      <main>
        <section classNameName="max-w-full      ">
          {error && (
            <>
          ...
          <div className="xl:w-[100%]   lg:bg-white  lg:flex-col xl:flex xl:justify-between xl:h-screen xl:bg-[#fbf8f6] lg:justify-between">
            <aside className="font-ambitregular relative  flex flex-col xl:gap-10 items-left xl:h-[25em] lg:h-[15em] xl:p-16 lg:p-8 lg:gap-10 ">
              <figure
                onClick={() => navigate("/home")}
                className="w-14 xl:mb-12 lg:mt-7">
                <img src={logo} alt="" />
              </figure>
              <div className="lg:mt-5 xl:mt-3 flex flex-col xl:gap-8 lg:gap-5">
                ...
                <div>
                  <h2 className="text-[#333333] lg:text-2xl  leading-[50px] xl:text-4xl">
                    Sign in to AgroFundX
                  </h2>
                </div>
              </div>
            </aside>
            <div className=" xl:rounded-tl-[5em] xl:bg-white xl:h-full xl:w-[55em] xl:shadow-xl">
              <header className="">
              ...
              <form onSubmit={handleSubmit}>
                <div className="xl:px-32 xl:h-[25em] xl:py-12 px-32 lg:p-8">
                  ...
                  <div onClick={()=>navigate("/facesignin")} className="underline w-fit pt-5 hover:no-underline cursor-pointer text-darkgray">
