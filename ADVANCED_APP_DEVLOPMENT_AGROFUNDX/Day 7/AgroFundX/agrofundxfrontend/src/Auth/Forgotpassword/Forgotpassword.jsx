...
import { useOtp,useVerifyEmail } from "../../useContext/UseStates";
...
const Forgotpassword = () => {
  ...
  return (
    <div>
      <main>
        <section className="max-w-full  font-ambitregular  ">
          {error && (
            <>
          ...
          <div className=" xl:w-[100%] z-[2] lg:bg-white lg:flex-col xl:flex xl:justify-between xl:h-screen  xl:bg-lightwhite lg:h-screen  lg:justify-between">
            <aside className="font-ambitregular relative  flex flex-col xl:gap-10 items-left xl:h-[25em]   xl:p-16 lg:p-8 lg:gap-10 ">
              <figure
                onClick={() => navigate("/signin")}
                className="w-14 xl:mb-12 lg:mt-10">
                <img src={logo} alt="" />
              </figure>
              <div className="lg:mt-5 xl:mt-16  flex flex-col xl:gap-8 lg:gap-5">
                <div>
                  <h2 className="text-[#333333] lg:text-2xl  leading-[50px] xl:text-4xl">
                    Let's find your AgroFundX account
                  </h2>
                </div>
              </div>
            </aside>
            <div className="  xl:rounded-tl-[5em]  bg-white flex flex-col  xl:w-[55em] xl:shadow-xl">
              <header className="">
